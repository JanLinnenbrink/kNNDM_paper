...
W_RMSE <- ggplot(pl_tab, aes(x=k, y=median, ymin=Q1, ymax=Q3)) +
    geom_line(aes(group=design), colour="navy") +
  geom_point(shape=21, size=1, colour="navy") +
    geom_errorbar(width=0.4, linewidth=0.2, colour="navy") +
