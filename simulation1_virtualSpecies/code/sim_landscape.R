...
st_write(spoly, dsn="simulation1_virtualSpecies/data/species_vdata.gpkg", layer="sampling_polygon")
st_write(wgrid, dsn="simulation1_virtualSpecies/data/species_vdata.gpkg", layer="landscape_grid")
writeRaster(wclim,  "simulation1_virtualSpecies/data/species_stack.grd", format="raster")
