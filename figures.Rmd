...
The following code reproduces figure 6, which compares NNDM LOOCV and kNNDM CV regarding their computational time requirements.

```{r figure time analysis, fig.width=8.5,fig.height=6, message=FALSE}
...
The following code reproduces figure 7, which shows the association between the absolute value difference between the CV and true map accuracy statistics and W statistic.
