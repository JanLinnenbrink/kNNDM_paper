...
#ggsave("figures/fig6_results_W_err.pdf",c, height=5, width=12)
comb
```
...
time_res <- bind_rows(read.csv("results/time_res_sclust.csv"),
                      read.csv("results/time_res_rand.csv")) |> 
...
#ggsave("figures/fig7_time_analysis.pdf", tp_ext, height=6, width=8.5)
